                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.members.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="position" class="block mt-1 w-full" type="text" name="position" :value="old('position')" required placeholder="e.g., CEO, Lead Developer" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="bio" name="bio" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="A brief description about the member...">{{ old('bio') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-sm text-gray-500 mt-1">PNG, JPG, JPEG, GIF, SVG (Max 2MB)</p>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="linkedin_url" class="block mt-1 w-full" type="url" name="linkedin_url" :value="old('linkedin_url')" placeholder="e.g., https://linkedin.com/in/johndoe" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="email_url" class="block mt-1 w-full" type="email" name="email_url" :value="old('email_url')" placeholder="e.g., john.doe@example.com" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="instagram_url" class="block mt-1 w-full" type="url" name="instagram_url" :value="old('instagram_url')" placeholder="e.g., https://instagram.com/username" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="facebook_url" class="block mt-1 w-full" type="url" name="facebook_url" :value="old('facebook_url')" placeholder="e.g., https://facebook.com/username" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="github_url" class="block mt-1 w-full" type="url" name="github_url" :value="old('github_url')" placeholder="e.g., https://github.com/username" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="twitter_url" class="block mt-1 w-full" type="url" name="twitter_url" :value="old('twitter_url')" placeholder="e.g., https://twitter.com/username" />
